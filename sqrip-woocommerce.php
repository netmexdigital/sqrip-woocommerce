...
add_action('admin_enqueue_scripts', function ($hook_suffix) {
    ...
    wp_enqueue_style('sqrip-admin', plugins_url('css/sqrip-admin.css', __FILE__), '', '1.11.0-beta42');
    ...
    if (isset($_GET['section']) && $_GET['section'] == "sqrip") {
        ...
        wp_enqueue_script('sqrip-admin', plugins_url('js/sqrip-admin.js', __FILE__), array('jquery', 'selectWoo'), '1.11.0-beta42', true);

        wp_enqueue_script('sqrip-avis', plugins_url('js/sqrip-avis.js', __FILE__), array('jquery', 'sqrip-admin'), '1.11.0-beta42', true);
    ...
    if (is_object($screen) && (
        ...
        wp_enqueue_script('sqrip-order', plugins_url('js/sqrip-order.js', __FILE__), array('jquery'), '1.11.0-beta42', true);
        wp_enqueue_script('sqrip-refund', plugins_url('js/sqrip-refund.js', __FILE__), array('jquery'), '1.11.0-beta42', true);
    ...
    if (in_array($hook_suffix, ['user-edit.php', 'profile.php'])) {
        wp_enqueue_script('sqrip-customer-profile', plugins_url('js/sqrip-customer-profile.js', __FILE__), array('jquery'), '1.11.0-beta42', true);
...
function sqrip_enqueue_scripts()
{
    ...
    wp_enqueue_style('sqrip', plugins_url('css/sqrip-order.css', __FILE__), array(), '1.11.0-beta42');

    wp_enqueue_script('sqrip', plugins_url('js/sqrip-fe.js', __FILE__), array('jquery'), '1.11.0-beta42', true);
